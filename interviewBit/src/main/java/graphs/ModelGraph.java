...
class ModelGraph
{
    ...
    private ModelGraph(List<Edge> edges)
    {
    ...
    private static void printGraph(ModelGraph graph)
    {
        int src = 0;
    ...
    // Directed WeightedModelGraph Implementation in Java
    public static void main (String[] args)
    {
        ...
        ModelGraph graph = new ModelGraph(edges);
